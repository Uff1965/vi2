...
extern "C" {
	...
	VI_TM_API int VI_TM_CALL vi_WarmUp(unsigned threads VI_DEFAULT(0), unsigned ms VI_DEFAULT(500));
	...
	VI_TM_API VI_TM_SIZE VI_TM_CALL vi_tmF2A(
		char *buff,
		VI_TM_SIZE sz,
		double val,
		unsigned char sig VI_DEFAULT(2),
		unsigned char dec VI_DEFAULT(1)
	);
